        ...
        <div className="relative z-10">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              >
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    {...register('firstName')}
                    className="w-full pl-12 pr-4 py-3.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-white/90 backdrop-blur-sm text-gray-900"
                    placeholder="First name"
                  />
                </div>
                {errors.firstName && (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <input
                    type={showPassword ? 'text' : 'password'}
                    {...register('password')}
                    className="w-full pl-12 pr-12 py-3.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-white/90 backdrop-blur-sm text-gray-900"
                    placeholder="Create password"
                  />
                  <button
                    type="button"
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <label className={`relative cursor-pointer group transition-all duration-200 ${selectedRole === 'CUSTOMER' ? 'ring-2 ring-offset-2' : ''}`}
                ...
                >
                  ...
                  style={{ borderColor: selectedRole === 'CUSTOMER' ? primaryColor : undefined }}
                  >
                    <div className="flex items-center space-x-4">
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-200 shadow-lg`}
                        style={{ backgroundColor: selectedRole === 'CUSTOMER' ? primaryColor : '#e5e7eb' }}
                      >
                        <ShoppingBag size={18} className={selectedRole === 'CUSTOMER' ? 'text-white' : 'text-gray-500'} />
                      </div>
                      <div>
                ...
                <label className={`relative cursor-pointer group transition-all duration-200 ${selectedRole === 'SELLER' ? 'ring-2 ring-offset-2' : ''}`}
                  style={{ '--tw-ring-color': primaryColor }}
                >
                  <input
                    type="radio"
                  ...
                  style={{ borderColor: selectedRole === 'SELLER' ? primaryColor : undefined }}
                  >
                    <div className="flex items-center space-x-4">
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-200 shadow-lg`}
                        style={{ backgroundColor: selectedRole === 'SELLER' ? primaryColor : '#e5e7eb' }}
                      >
                        <Store size={18} className={selectedRole === 'SELLER' ? 'text-white' : 'text-gray-500'} />
                      </div>
                      <div>
            ...
            <motion.button
              ...
              type="submit"
              disabled={isLoading}
              className="w-full text-white py-4 px-8 rounded-xl font-semibold text-lg focus:ring-4 focus:ring-blue-200 transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center space-x-3 shadow-xl"
              style={{ 
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              >
                <Leaf size={18} style={{ color: primaryColor }} />
              </div>
              <div>
