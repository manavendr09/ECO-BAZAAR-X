...
//               © 2024 EcoBazaarX. All rights reserved.
//             </div>
    ...
    <footer className="footer bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:support@ecobazaarx.com" className="text-gray-300 hover:text-white transition-colors text-sm">
                  support@ecobazaarx.com
                </a>
              </div>
              <div className="flex items-center space-x-3">
                <Phone size={16} className="text-green-400" />
                <a href="tel:+919580227087" className="text-gray-300 hover:text-white transition-colors text-sm">
                  +91 95802 27087
                </a>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © 2026 EcoBazaarX. All rights reserved.
            </div>
            <div className="flex space-x-6 text-sm">
              <Link to="/privacy" className="text-gray-400 hover:text-white transition-colors">
                Privacy Policy
